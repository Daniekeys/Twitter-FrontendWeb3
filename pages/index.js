...
const style = {
  wrapper: `flex justify-center h-screen scroll-hide  w-screen select-none bg-[#15202b] text-white overflow-x-hidden`,
  content: `max-w-[1400px] w-10/12 flex justify-between relative`,
